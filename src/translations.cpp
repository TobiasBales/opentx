...
const pm_char STR_VALUES[] PROGMEM = TR_VALUES;
...
#if defined(STATES)
const pm_char STR_STATE[] PROGMEM = TR_STATE;
#endif
...
const pm_char STR_MENUSTATES[] PROGMEM = TR_MENUSTATES;
...
const pm_char STR_FAILSAFE_ACTIVE[] PROGMEM = TR_FAILSAFE_ACTIVE;
